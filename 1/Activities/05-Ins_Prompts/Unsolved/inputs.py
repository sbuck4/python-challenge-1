...
grocery_bill = float(input("what's you average weekly grocery bill?"))
...
true_or_false = bool(input("will you type and input?"))
...
print("I spend an average of $" + str(grocer_bill) + "per weeek on groceries")
